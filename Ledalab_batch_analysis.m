...
path_with_baseline = '/Users/nope/ownCloud/work/uka/code/LAC-2018/data/Ledalab-batch-analysis/elisas-params/with-baseline/';
path_without_baseline = '/Users/nope/ownCloud/work/uka/code/LAC-2018/data/Ledalab-batch-analysis/elisas-params/no-baseline/';

downsample_parameters = [5];
...
downsample_parameters = [2];
filter_parameters = [[1 2]];
era_settings = [[0.8 10.8 .05 2]];
scr_settings = [[.05 2]];


downsample_parameter = downsample_parameters(1);
%% with baseline
j=1;
...
for filter_parameter = filter_parameters'
    for era_setting = era_settings'
        for scr_setting = scr_settings'
            ...
            ledalab_batch_analysis(path, downsample_parameter, filter_parameter', optimize_level', era_setting', scr_setting')
            j=j+1;
        end
    end
end
...
function[] = ledalab_batch_analysis(path, downsample_parameter, filter_parameter, optimize_level, era_setting, scr_setting)
    if filter_parameter == 0
        Ledalab(path ,'open','mat', ...
        'downsample', downsample_parameter, ...
        'analyze','CDA' , ...
